This is a WordPress plugin. However, [/js/map.js](https://github.com/anewholm/geo-hcard-map/blob/master/js/map.js) will work independently if [leaflet.js](http://leafletjs.com/) is loaded.
```html
